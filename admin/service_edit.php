...
$show_faq = $service_controller->showfaq($id);
if (isset($_POST['update'])) {
    $title = $_POST['title'];
    $content = $_POST['content'];

    $addfaq = $service_controller->updatefaq($id, $title, $content);
    if ($addfaq) {
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form action="" class="p-3" method="post">
                    ...
                    <input type="text" class="form-control mb-3" name="title" id="title" autocomplete="off" value="<?php echo $show_faq['title'] ?>">

                    <label for="summernote">Content</label>
                    <div class="bg-dark">
                        <textarea name="content" class="text-dark" id="summernote" cols="30" rows="10" required><?php echo $show_faq['content'] ?></textarea>
                    </div>
